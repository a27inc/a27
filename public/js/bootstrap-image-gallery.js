...
$(document).ready(function(){
    ...
    $('#blueimp-gallery').data('youTubeClickToPlay', true);
    
    $('#links a').click(function(e){
        e.preventDefault();
        window.gallery = blueimp.Gallery(window.gobject, $('#blueimp-gallery').data());
        window.gallery.slide(parseInt($(this).attr('index')));
